    ...
    <form method="post" action="/blog">
        ...
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                <h2 class="text-base/7 font-semibold text-white">create new profile</h2>
                <p class="mt-1 text-sm/6 text-gray-600">use this form to publish a new post to this blog</p>
