    ...
    <form method="post" action="/blog/{{ $post->id }}">
        ...
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                ...
                <p class="mt-1 text-sm/6 text-gray-600">use this form to edit tp edit your </p>

                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-3">
                        <label for="title" class="block text-sm/6 font-medium text-white">Title</label>
                        <div class="mt-2">
                            <input id="title" type="text" value="{{ old('title', $post->title) }}" name="title"
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                            <input id="author" type="text" value="{{ old('author', $post->author) }}" name="author"
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            <textarea id="body" name="body" rows="3"
                                class="{{ $errors->has('body') ? 'outline-red-500' : 'outline-gray-300'}} block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">{{ $post->body }}</textarea>
                        </div>
                        @error('body')
                            <span class="text-red-500">{{ $message }}</span>
                        @enderror
                        <p class="mt-3 text-sm/6 text-gray-600">Write a few sentences about artical.</p>
                    </div>
                    <div class="col-span-full">
                        <div class="flex gap-3">
                            <div class="flex h-6 shrink-0 items-center">
                                <div class="group grid size-4 grid-cols-1">
                                    <input id="published" type="checkbox" name="published" aria-describedby="published"
                            ...
                            <div class="text-sm/6">
                                <label for="candidates" class="font-medium text-white">Is published?</label>
                                <p id="candidates-description" class="text-gray-500">do you want it published or saved
                                    as draft.</p>
                            </div>
                        </div>
                    </div>
